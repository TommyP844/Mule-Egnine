...
namespace Mule
{
	VulkanDescriptorSet::VulkanDescriptorSet(WeakRef<GraphicsContext> context, const std::vector<WeakRef<VulkanDescriptorSetLayout>>& layouts)
		:
		mContext(context),
	...
	void VulkanDescriptorSet::Update(const std::vector<DescriptorSetUpdate>& updates)
	{
