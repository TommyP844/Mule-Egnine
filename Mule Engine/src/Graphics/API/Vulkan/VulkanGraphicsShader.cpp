#include "Graphics/API/Vulkan/VulkanGraphicsShader.h"
...
namespace Mule
{
	VulkanGraphicsShader::VulkanGraphicsShader(WeakRef<GraphicsContext> context, const fs::path& filepath)
		:
	...
	void VulkanGraphicsShader::Reload()
	{
		mIsValid = false;
	...
	const std::pair<uint32_t, uint32_t>& VulkanGraphicsShader::GetPushConstantRange(ShaderStage stage)
	{
