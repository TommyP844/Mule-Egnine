#include "Graphics/API/Vulkan/VulkanUniformBuffer.h"
...
namespace Mule
{
	VulkanUniformBuffer::VulkanUniformBuffer(WeakRef<GraphicsContext> context, uint32_t bytes)
		:
	...
	Buffer VulkanUniformBuffer::ReadData(uint32_t offset, uint32_t size)
	{
		Buffer buffer(size);
