...
layout(set = 0, binding = 1, rgba16f) writeonly uniform imageCube cubemapImage;

layout(local_size_x = 32, local_size_y = 32) in;  // Workgroup size
...
void main() {
    ...
    uint y = cubeSize.y - gl_GlobalInvocationID.y;
